<template>
  <div class="text-sm text-[#303133]">
    ...
    <p class="mb-[20px]">
      进入
      <a href="//open.feishu.cn/" target="_blank" class="text-[#0256FF]">「飞书开放平台」</a>
      完成设置，填写以下信息
    </p>
      ...
      >
        ...
        <el-form-item label="Verification Token" prop="verification_token">
          <el-input
            ...
            placeholder="请填写Verification Token"
          />
        </el-form-item>
...
const createPublicRule = reactive({
  app_id: [{ required: true, message: '请填写开发者ID', trigger: 'blur' }],
  app_secret: [{ required: true, message: '请填写开发者密码', trigger: 'blur' }],
  encrypt_key: [{ required: true, message: '请填写开发者密码', trigger: 'blur' }],
  verification_token: [{ required: true, message: '请填写开发者密码', trigger: 'blur' }]
})
